Feature: user is able to navigate through the most important analysis functions

  In order to focus on things that matter
  Abraham would like to navigate through the most important analysis functions
